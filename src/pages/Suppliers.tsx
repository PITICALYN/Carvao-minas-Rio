...
export const Suppliers = () => {
    const { suppliers, addSupplier, getSupplierStats } = useAppStore();
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {suppliers.map((supplier) => {
                    ...
                    return (
                        <div key={supplier.id} className="glass-card p-6 rounded-2xl">
            ...
            {isModalOpen && (
                <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50">
                    <div className="glass-panel p-6 rounded-2xl w-full max-w-md shadow-2xl border border-white/10">
                        <h3 className="text-xl font-bold mb-4 text-white">Novo Fornecedor</h3>
